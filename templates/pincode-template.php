...
<article>
  ...
  <section><h2>Nearby pincodes</h2><ul><?php foreach ($pageData['nearby_links'] as $link): ?><li><a href="<?= $link['path'] ?>"><?= htmlspecialchars($link['label']) ?></a></li><?php endforeach; ?></ul></section>
