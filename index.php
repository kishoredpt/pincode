                ...
                foreach ($pageData as $pinRow) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            $pinLat = $normalizedLat;
                            $pinLon = $normalizedLon;
                            break;
                        }
                    }
                }
            ...
            ");
                if ($stmtRail) {
                    ...
                    if ($railRes && $railRes->num_rows > 0) {
                        $candidateNearest = $railRes->fetch_assoc();
                        $candidateDistance = isset($candidateNearest['distance_km'])
                            ? (float)$candidateNearest['distance_km']
                            : null;

                        if ($candidateDistance !== null && $candidateDistance <= 500.0) {
                            $nearestRailwayContext = $candidateNearest;
                        }
                    }
                }
